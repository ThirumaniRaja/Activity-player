var menuBox = function() {
  ...
  var rotateObj = {
    ...
    menu_2: {
      ...
      width: '120px',
      height: '26px',
      rotate: 'rotate(4deg) skewX(11deg)'
    },
    menu_3: {
      left: '58px',
      bottom: '',
    ...
    for (var i = p.noOfMenus; i >= 1; i--) {
      ...
      $(_Div)
        .css({
          ...
          bottom: _bottom,
          width: '120px',
          height: rotateObj['menu_' + i]['height'],
          'background-color': 'rgba(0,0,0,0)',
