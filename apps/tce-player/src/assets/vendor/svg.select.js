...
SelectHandler.prototype.drawPoint = function(cx, cy) {
  ...
  //console.log("​SelectHandler.prototype.drawPoint -> pointType", pointType)
...
SVG.extend(SVG.Element, {
  ...
  selectize: function(value, options) {
    ...
    var selectHandler =
      this.remember('_selectHandler') || new SelectHandler(this);
...
SVG.Element.prototype.selectize.defaults = {
  ...
  //points: ['rb'],    // which points to draw, default all
  pointsExclude: [], // easier option if to exclude few than rewrite all
  classRect: 'svg_select_boundingRect', // Css-class added to the rect
  classPoints: 'svg_select_points', // Css-class added to the points
  pointSize: 14, // size of point
  rotationPoint: true, // If true, rotation point is drawn. Needed for rotation!
  deepSelect: true, // If true, moving of single points is possible (only line, polyline, polyon)
  pointType: 'circle', // Point type: circle or rect, default circle
  pointFill: 'transparent', // Point fill color
  pointStroke: { width: 1, color: '#a09d9d' } // Point stroke properties
};
