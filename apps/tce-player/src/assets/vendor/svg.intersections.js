...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) define(['svg.js'], factory);
  else if (typeof module === 'object' && module.exports)
    module.exports = factory(require('svg.js'));
  else root.SVGIntersections = factory(root.SVG);
})(this, function(SVG) {
  var defaults = {
    segmentLength: 10
  };
  ...
  SVG.extend(SVG.Path, {
    ...
    intersectsPath: function(path, segmentLength) {
      ...
      for (var i = 0; i < numberOfSegments; i++) {
        ...
        //console.log("lineSegmentPos -- ",lineSegmentPos);
        var positions = path_linePos(path, lineSegmentPos, segmentLength);
        ...
        if (positions.length) {
          positions.forEach(function(el) {
            ...
            if (allPositions.length >= 1) {
              ...
              // Return is the same
              if (lastEl.x === el.x && lastEl.y === el.y) return;
            }
  ...
  function linePos_linePos(line1Pos, line2Pos) {
    ...
    line2StartInLine1 = isPointOnLine(
      line1StartX,
      line1StartY,
      line1EndX,
      line1EndY,
    ...
    if (line2StartInLine1) return line2StartInLine1;

    line2EndInLine1 = isPointOnLine(
      line1StartX,
      line1StartY,
      line1EndX,
      line1EndY,
    ...
    if (line2EndInLine1) return line2EndInLine1;

    line1StartInLine2 = isPointOnLine(
      line2StartX,
      line2StartY,
      line2EndX,
      line2EndY,
    ...
    if (line1StartInLine2) return line1StartInLine2;

    line1EndInLine2 = isPointOnLine(
      line2StartX,
      line2StartY,
      line2EndX,
      line2EndY,
    ...
    if (line1EndInLine2) return line1EndInLine2;
    ...
    if (a > 0 && a < 1) onLine1 = true;

    // If line2 is a segment and line1 is infinite, they intersect if:
    if (b > 0 && b < 1) onLine2 = true;
